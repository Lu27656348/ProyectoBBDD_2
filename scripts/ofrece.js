const url = 'http://localhost:3000/Ofrece/';
...
formLinea.addEventListener('submit', (e)=>{
    ...
    if(opcion=='crear'){
       console.log('creando en: '+ urlaux+filarif+'/Servicio/'+filacod);
       fetch(urlaux+filarif+'/Servicio/'+filacod, {
           method: 'POST',
           headers: {'Content-Type':'application/json'},
           body: JSON.stringify({
                riflocal: riflocal.value,
